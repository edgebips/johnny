...
Chains = _reflection.GeneratedProtocolMessageType(
    "Chains",
    (_message.Message,),
    {
        "DESCRIPTOR": _CHAINS,
...
SplitTransaction = _reflection.GeneratedProtocolMessageType(
    "SplitTransaction",
    (_message.Message,),
    {
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _CHAINSTATUS._serialized_start = 645
    _CHAINSTATUS._serialized_end = 705
    _CHAINS._serialized_start = 36
    _CHAINS._serialized_end = 129
    _CHAIN._serialized_start = 132
    _CHAIN._serialized_end = 467
    _ASSET._serialized_start = 469
    _ASSET._serialized_end = 527
    _SPLITTRANSACTION._serialized_start = 529
    _SPLITTRANSACTION._serialized_end = 643
    _SPLITTRANSACTION_PART._serialized_start = 607
    _SPLITTRANSACTION_PART._serialized_end = 643
