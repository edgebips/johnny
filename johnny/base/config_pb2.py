...
from johnny.base import chains_pb2 as johnny_dot_base_dot_chains__pb2
...
_CONFIG.fields_by_name['chains'].message_type = johnny_dot_base_dot_chains__pb2._CHAIN
