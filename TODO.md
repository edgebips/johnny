...
Reduce the following loops and dependencies on positions to a single loop at all:
    ...
    /home/blais/p/johnny/johnny/sources/ameritrade/transactions.py:827:    inventory = collections.defaultdict(match.MinInventory)

      _AddMissingExpirations()

    /home/blais/p/johnny/johnny/sources/tastyworks/transactions.py:202:    inventory = collections.defaultdict(Decimal)
